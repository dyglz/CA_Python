...
class Task:
    def __init__(self, description: str = "", category: str = "", deadline: str = "%Y-%m-%d", priority: Tuple[str] = ("low", "medium", "high"), status: bool = False):
    ...
    def __str__(self):
        return f"Description: {self.description}, Category: {self.category}, Deadline: {self.deadline}, Priority: {self.priority}, Status: {'[✔]' if self.status else '[ ]'}"
...
class Task_manager:
    ...
    def add_task(self):
        ...
        self.all_tasks.sort(key=lambda x: x.priority)
